                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            <h1 class="display-5 fw-bolder text-white mb-2">ありがとうございました！</h1>
                            <p class="lead text-white-50 mb-4">お引越しのご依頼を受け付けました。</p>
                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center ms-auto">
                              <a class="btn btn-primary btn-lg px-4 me-sm-3" href="./index.php">トップページに戻る</a>
